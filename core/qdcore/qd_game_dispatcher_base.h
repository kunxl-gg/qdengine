...
#ifndef QDENGINE_CORE_QDCORE_QD_GAME_DISPATCHER_BASE
#define QDENGINE_CORE_QDCORE_QD_GAME_DISPATCHER_BASE
...
#endif /* QDENGINE_CORE_QDCORE_QD_GAME_DISPATCHER_BASE */
